...
public class AuthController {
    ...
    public RegisterResponse register(@RequestBody RegistrationMember registrationMember) {
        Member newMember = authenticationService.register(registrationMember.email(), registrationMember.password());
        return new RegisterResponse(newMember.getEmail(), "kayıt başarılı bir şekilde gerçekleşti.");
    }
}
