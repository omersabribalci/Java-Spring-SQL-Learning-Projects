...
public class Converter {
    public static List<ActorResponse> actorResponseConverter(List<Actor> actors) {
    ...
    public static ActorResponse actorCreateResponseConvert(Actor savedActor) {
        return new ActorResponse(
                savedActor.getId(), savedActor.getFirstName(),
                savedActor.getLastName(), savedActor.getBirthDate(),
                savedActor.getMovies()
                );
    }
}
